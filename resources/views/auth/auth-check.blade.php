...
<body>
	...
	<section id = 'login_backDrop'>
		...
		<section id = 'form_wrapper'>
            ...
            <form method="POST" action="/check-auth-code">
                @csrf
     
                <!-- Username -->
                <div class = 'login_inputGrouping'>
                    <i class="login_icon fa fa-user" style="font-size:23px"></i>
                    <x-input id="twoFactorCode" class="block mt-1 w-full" type="text" name="twoFactorCode" required autofocus />
                </div>

                <div class = 'login_inputGrouping'>
                    <input type = 'submit' name = 'submitCode' value = 'Submit'></input>
                </div>
            </form>
