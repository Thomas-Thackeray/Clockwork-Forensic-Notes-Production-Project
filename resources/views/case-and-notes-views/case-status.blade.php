<x-app-layout :case_name="$case_name" :caseID="$caseID">
    ...
    <section id = 'mainContent-container' class = 'flex-row flex-wrap'>
        ...
        <form action = '/case/{{$case_name}}/submit-note/case-status' method = 'POST' enctype='multipart/form-data' class = 'flex-row flex-wrap full-width'>
            ...
            <section class = 'white-box full-width'>
                ...
                <section class = 'large-grouping-form flex-column'>
                    ...
                    <span class = 'form-row-grouping flex-row'>
                        <select name = 'changeStatus_input'class = 'MR-20 thirty-percent-width'>
                    ...
                    <span class = 'form-column-grouping flex-column'>
                        <textarea name = 'reasonForChange_input' class = 'MB-10' placeholder = "Reason For Status Change"></textarea>
                    </span>                
