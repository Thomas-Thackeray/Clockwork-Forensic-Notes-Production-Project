<x-app-layout :case_name="$case_name">
    ...
    <section id = 'mainContent-container' class = 'flex-row flex-wrap'>
        ...
        <form action = '/case/{{$case_name}}/submit-note/evidence-identification' method = 'POST' enctype='multipart/form-data' class = 'flex-row flex-wrap full-width'>
            ...
            <section class = 'white-box full-width'>
                ...
                <section class = 'large-grouping-form flex-column'>
                    ...
                    <span class = 'form-column-grouping flex-column'>
                        <input class = 'MR-20 MB-10 thirty-percent-width' value = "{{ old('crimeSceneName_input') }}" type="text" name="crimeSceneName_input" placeholder = "Crime Scene Name">
                        @error('crimeSceneName_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <textarea name = 'crimeSceneDescription_input' placeholder = "Crime Scene Description">{{ old('crimeSceneDescription_input') }}</textarea>
                        @error('crimeSceneDescription_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                    </span>

                    <h3>Items Of Intrest / Evidence Seen</h3>

                    <span class = 'flex-column three-column-grouping flex-wrap'>
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem1_input') }}" name="evidenceItem1_input" placeholder = "Item 1">
                        @error('evidenceItem1_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem2_input') }}" name="evidenceItem2_input" placeholder = "Item 2">
                        @error('evidenceItem2_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem3_input') }}" name="evidenceItem3_input" placeholder = "Item 3">
                        @error('evidenceItem3_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem4_input') }}" name="evidenceItem4_input" placeholder = "Item 4">
                        @error('evidenceItem4_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem5_input') }}" name="evidenceItem5_input" placeholder = "Item 5">
                        @error('evidenceItem5_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem6_input') }}" name="evidenceItem6_input" placeholder = "Item 6">
                        @error('evidenceItem6_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem7_input') }}" name="evidenceItem7_input" placeholder = "Item 7">
                        @error('evidenceItem7_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem8_input') }}" name="evidenceItem8_input" placeholder = "Itam 8">
                        @error('evidenceItem8_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem9_input') }}" name="evidenceItem9_input" placeholder = "Item 9">
                        @error('evidenceItem9_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                        <input class = 'MR-20 MB-10 thirty-percent-width' type="text" value = "{{ old('evidenceItem10_input') }}" name="evidenceItem10_input" placeholder = "Itam 10">
                        @error('evidenceItem10_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                    </span>      
