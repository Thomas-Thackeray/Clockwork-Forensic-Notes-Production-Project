<x-app-layout :case_name="$case_name" :caseID="$caseID">
    ...
    <section id = 'mainContent-container' class = 'flex-row flex-wrap'>
        ...
        <form action = '/case/{{$case_name}}/submit-note/initial-evidence-state' method = 'POST' enctype='multipart/form-data' class = 'flex-row flex-wrap full-width'>
            ...
            <section class = 'white-box full-width'>
                ...
                <section class = 'large-grouping-form flex-column'>
                    ...
                    <span class = 'form-row-grouping flex-row'>
                        <select name = 'evidence_ref_input' value = "{{ old('evidence_ref_input') }}" class = 'MR-20 thirty-percent-width'>
                        ...
                        @error('evidence_ref_input')<p class="validation_message warning">{{ $message }}</p>@enderror

                    </span>

                    <span class = 'form-column-grouping flex-column'>
                        <textarea name = 'evidenceState_input' class = 'MB-10' placeholder = "Description Of Evidnce State On Finding.">{{ old('evidenceState_input') }}</textarea>
                        @error('evidenceState_input')<p class="validation_message warning">{{ $message }}</p>@enderror

                        <select name = 'power_status_input' value = "{{ old('power_status_input') }}" class = 'MR-20 MB-10 thirty-percent-width'>
                        ...
                        @error('power_status_input')<p class="validation_message warning">{{ $message }}</p>@enderror

                        <textarea name = 'connectHardrwae_input' class = 'MB-10' placeholder = "Connected / Inputed Hardware (Seperate By Using Commas ',')">{{ old('connectHardrwae_input') }}</textarea>
                        @error('connectHardrwae_input')<p class="validation_message warning">{{ $message }}</p>@enderror

                        <textarea name = 'cableConfig_input' class = 'MB-10' placeholder = "Cabling Configuration Description">{{ old('cableConfig_input') }}</textarea>
                        @error('cableConfig_input')<p class="validation_message warning">{{ $message }}</p>@enderror
                    </span>                
