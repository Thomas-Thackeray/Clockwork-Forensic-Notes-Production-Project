...
class initialEvidenceStateController extends Controller
{
    /**
    ...
    public function create($caseName)
    {
        ...
        return View::make('case-and-notes-views.initial-evidence-state', ['case_name' => $caseName, 'companie_name' => $companie_name, 'caseID' => $caseID]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            'evidence_ref_input' => 'required|max:30',
            'evidenceState_input' => 'required|max:255',
            'power_status_input' => 'required|max:15',
            'connectHardrwae_input' => 'max:255',
            'cableConfig_input' => 'max:255',
        ...
        $newNote->title=$request->evidence_ref_input;
        $newNote->description=$request->evidenceState_input;
        $newNote->power_status=$request->power_status_input;
        $newNote->hardware_connections=$request->connectHardrwae_input;
        $newNote->cable_configuration=$request->cableConfig_input;
        ...
        $newNote->note_type='Initial Evidence State'; 
